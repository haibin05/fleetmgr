    ...
    function PickerConstructor( ELEMENT, NAME, COMPONENT, OPTIONS ) {
        ...
        function prepareElementRoot() {
            ...
            P.$root.on('mousedown click', function( event ) {
                ...
                } else if ( event.type == 'click' && P.get('open') ) {console.log('----colose')
                    P.close();
                }
            });
            ...
            P.attachLiveEvents = function() {
                ...
                angular.element(P.$root[0].querySelectorAll('[data-pick], [data-nav], [data-clear], [data-close]')).off('click').on('click', function(event) {
