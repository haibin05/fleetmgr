 ...
 */
public class FleetServerAuthConfig implements ServerAuthConfig {
    ...
    public FleetServerAuthConfig(String layer, String appContext,
    ...
    public ServerAuthContext getAuthContext(String authContextID,
        ...
        return new FleetServerAuthContext(handler);
    }
