...
public class FleetAuthConfigProvider implements AuthConfigProvider {
    ...
    public FleetAuthConfigProvider() {
    }
     ...
     * @param factory
     */
    public FleetAuthConfigProvider(Map<String, String> properties,
    ...
    public ServerAuthConfig getServerAuthConfig(String layer,
            ...
            SecurityException {
        return new FleetServerAuthConfig(layer, appContext,
