    ...
    (function ($, undefined) {
        ...
        $.widget("mobile.navbar", {
            ...
            _create: function () {
                ...
                // Buttons in the navbar with ui-state-persistence class should regain their active state before page show
                $navbar.closest(".ui-page").bind("pagebeforeshow", function () {
                    $navbtns.filter(".ui-state-persistence").addClass($.mobile.activeBtnClass);
                });
            }
        });
