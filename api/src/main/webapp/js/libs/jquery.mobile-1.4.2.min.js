...
!function (a, b, c) {
    ...
    !function (a) {
        ...
        a.each(["animation", "transition"], function (c, g) {
            ...
            var h, i, j = this, k = f && "animation" !== f ? "transition" : "animation";
        ...
        a.widget("mobile.pagecontainer", {
            ...
            _handleNavigate: function (b, c) {
                var e = a.mobile.path.stripHash(b), f = this._getHistory(), g = 0 === f.stack.length ? "none" : d, h = {
                    changeHash: !1,
                    fromHashChange: !0,
                    reverse: "back" === c.direction
                };
            ...
            _triggerCssTransitionEvents: function (b, c, d) {
                ...
                d = d || "", c && (b[0] === c[0] && (e = !0), this._triggerWithDeprecated(d + "hide", {
                    nextPage: b,
                    samePage: e
                }, c)), this._triggerWithDeprecated(d + "show", {prevPage: c || a("")}, b)
            },
        ...
        var e = a.Deferred(), f = a.Deferred(), g = a.mobile.path.documentUrl, h = null;
        a.mobile.loadPage = function (b, c) {
            ...
            var e = function (b, c) {
                ...
                }), f && e.push({name: f, value: h.attr("value")}))), j = {
                    url: d,
                    options: {
                        type: i,
                        data: a.param(e),
            ...
            a.mobile.document.delegate("form", "submit", function (b) {
                ...
                if (a.mobile.linkBindingEnabled && !e.isDefaultPrevented()) {
                    var f, h, i, j, k, l, m, n = d(e.target), o = a(n), p = function () {
        ...
        a.widget("mobile.navbar", {
            options: {iconpos: "top", grid: null}, _create: function () {
                ...
                d.addClass("ui-navbar").attr("role", "navigation").find("ul").jqmEnhanceable().grid({grid: this.options.grid}), e.each(function () {
                    ...
                    e.filter(".ui-state-persistence").addClass(a.mobile.activeBtnClass)
                })
            }
        })
    }(a), function (a) {
        ...
        a.widget("mobile.checkboxradio", a.extend({
            ...
            _create: function () {
                var b = this.element, d = this.options, e = function (a, b) {
                    return a.jqmData(b) || a.closest("form, fieldset").jqmData(b)
                }, f = b.closest("label"), g = f.length ? f : b.closest("form, fieldset, :jqmData(role='page'), :jqmData(role='dialog')").find("label").filter("[for='" + c(b[0].id) + "']").first(), h = b[0].type, i = "ui-" + h + "-on", j = "ui-" + h + "-off";
        ...
        a.widget("mobile.selectmenu", a.mobile.selectmenu, {
            _create: function () {
                ...
                return w.nativeMenu ? this._super() : (v = this, c = this.selectId, d = c + "-listbox", e = c + "-dialog", f = this.label, g = this.element.closest(".ui-page"), h = this.element[0].multiple, i = c + "-menu", j = w.theme ? " data-" + a.mobile.ns + "theme='" + w.theme + "'" : "", k = w.overlayTheme || w.theme || null, l = k ? " data-" + a.mobile.ns + "overlay-theme='" + k + "'" : "", m = w.dividerTheme && h ? " data-" + a.mobile.ns + "divider-theme='" + w.dividerTheme + "'" : "", n = a("<div data-" + a.mobile.ns + "role='dialog' class='ui-selectmenu' id='" + e + "'" + j + l + "><div data-" + a.mobile.ns + "role='header'><div class='ui-title'>" + f.getEncodedText() + "</div></div><div data-" + a.mobile.ns + "role='content'></div></div>"), o = a("<div id='" + d + "' class='ui-selectmenu'></div>").insertAfter(this.select).popup({theme: w.overlayTheme}), p = a("<ul class='ui-selectmenu-list' id='" + i + "' role='listbox' aria-labelledby='" + this.buttonId + "'" + j + m + "></ul>").appendTo(o), q = a("<div class='ui-header ui-bar-" + (w.theme ? w.theme : "inherit") + "'></div>").prependTo(o), r = a("<h1 class='ui-title'></h1>").appendTo(q), this.isMultiple && (u = a("<a>", {
                    ...
                    var c = v.select[0].selectedIndex, d = a.mobile.getAttribute(this, "option-index"), e = v._selectOptions().eq(d)[0];
                ...
                }), b.menuType = "page", b.menuPageContent.append(b.list), b.menuPage.find("div .ui-title").text(b.label.text())) : (b.menuType = "overlay", b.listbox.one({popupafteropen: a.proxy(this, "_focusMenuItem")}))
            }, _buildList: function () {
        ...
        a.widget("mobile.toolbar", {
            ...
            _addBackButton: function () {
                var b = this.options, c = b.backBtnTheme || b.theme;
        ...
        a.widget("mobile.filterable", {
            ...
            _filterItems: function (b) {
                ...
                0 === i.length ? k[j.filterReveal ? "addClass" : "removeClass"]("ui-screen-hidden") : (a(i).addClass("ui-screen-hidden"), a(h).removeClass("ui-screen-hidden")), this._refreshChildWidget(), this._trigger("filter", null, {items: k})
            },
