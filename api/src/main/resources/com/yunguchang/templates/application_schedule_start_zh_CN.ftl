...
<div class="group-item">
    <h5 class="item-header clearfix">
        <span class="pull-left">驾驶员出车</span>
    ...
    <div class="item-body">
        ...
        <#if (coordinator?? && coordinator) || (auditor?? && auditor)>
            ...
            <div class="bottom-bar clearfix">
                <#if coordinator?? && coordinator>
                    <a class="btn btn-default pull-right" href="${fleethost!}/mobile/#/applications/${r.apply.applyId!}/cars/${r.scheduleCar.carId!}/rate">评价司机</a>
                </#if>
            </div>
        </#if>
        ...
        <#if driver?? && driver>
            ...
            <assign class="bottom-bar clearfix"/>
            <a class="btn btn-default pull-right" href="${fleethost!}/mobile/#/scheduleCars/${r.scheduleCar.scheduleCarId!}/record/end">回厂</a>
        </#if>
    </div>
</div>
</body>
