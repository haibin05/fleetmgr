...
<div class="group-item">
    <h5 class="item-header clearfix">
        <span class="pull-left">评价用车人</span>
        <span class="pull-right">评价结束</span>
    </h5>
    ...
    <div class="item-body">
        ...
        <#if r.personScore?? && r.personScore>
        <p>评分: ${r.personScore!}</p>
        </#if>
<#if r.irregularReson?? && r.irregularReson>
        <p>不规范: ${r.irregularReson!}</p>
<#else>
    <p>不规范: ${r.irregularReson!}</p>
</#if>
        ...
        <div class="clearfix">
            ...
            <#if driver && driver>
                <a class="btn btn-default pull-right" href="${fleethost!}/mobile/#/applications/${r.applyId!}">申请评分详情</a>
            </#if>
        </div>
    </div>
</div>
