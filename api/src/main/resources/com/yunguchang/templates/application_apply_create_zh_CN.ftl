    ...
    <div class="item-body">
        ...
        <div class="bottom-bar clearfix">
            <#if coordinator?? && coordinator>
                <a class="btn btn-default pull-right" href="${fleethost!}/mobile/#/applications/${r.apply.applyId!}">申请详情</a>
            </#if>
            <#if auditor?? && auditor>
                <a class="btn btn-default pull-right" href="${fleethost!}/mobile/#/applications/${r.apply.applyId!}/schedule/step0">审批</a>
            </#if>
            <#if dispatcher?? && dispatcher>
                <a class="btn btn-default pull-right" href="${fleethost!}/mobile/#/applications/${r.apply.applyId!}/schedule/step1">派单</a>
            </#if>
        </div>
    </div>
