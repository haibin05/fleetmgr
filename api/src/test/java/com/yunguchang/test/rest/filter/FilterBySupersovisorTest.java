 ...
 */
public class FilterBySupersovisorTest extends AbstractFilterRestTest {
    @Override
    ...
    @Test
    public void testFilterAttendance(
            @ArquillianResteasyResource("api") AuthService authService,
            @ArquillianResteasyResource("api/drivers/1065496/state") WebTarget webTarget)
            throws Exception {
        ...
        ;
        assertEquals(200, response.getStatus());
        DriverInfo driverInfo = response.readEntity(DriverInfo.class);
